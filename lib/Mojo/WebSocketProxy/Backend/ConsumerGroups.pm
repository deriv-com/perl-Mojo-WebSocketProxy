...
=item * C<msg_group> If supplied, the message will be assigned to the Redis Channel with the corresponding name. The I<< general >> channel will be used by default in case C<< $msg_type >> is not provided.
